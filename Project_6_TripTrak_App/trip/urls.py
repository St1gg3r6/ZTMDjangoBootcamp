...
from .views import HomeView, TripCreateView, TripDetailView, TripUpdateView, TripDeleteView, NoteDetailView, NoteListView, NoteCreateView, NoteUpdateView, NoteDeleteView, trips_list
